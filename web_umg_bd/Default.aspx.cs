...
namespace web_umg_bd {
  public partial class _Default : Page {
    ...
    protected void btn_agregar_Click(object sender, EventArgs e) {
      estudiante = new Estudiante();
      if (estudiante.agregar(txt_carne.Text, txt_nombres.Text, txt_apellidos.Text, txt_direccion.Text, txt_telefono.Text, txt_correo.Text, Convert.ToInt32(drop_sangre.SelectedValue), txt_fn.Text) > 0) {
    ...
    protected void btn_modificar_Click(object sender, EventArgs e) {
      estudiante = new Estudiante();
      if (estudiante.modificar(Convert.ToInt32(grid_estudiantes.SelectedValue), txt_carne.Text, txt_nombres.Text, txt_apellidos.Text, txt_direccion.Text, txt_telefono.Text, txt_correo.Text, Convert.ToInt32(drop_sangre.SelectedValue), txt_fn.Text) > 0) > 0) {
